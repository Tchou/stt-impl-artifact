...
ℂDuce is a functional programming language featuring set-theoretic types and
semantic sub-typing. It is adapted to the manipulation of XML documents but features general purpose programming aspects such as:
- semantic sub-typing
- higher-order function
- rich pattern-matching (including regular expression types and patterns)
- extensible record types
- parametric polymorphism

It is currently developed as a joint research project between the IRIF lab (UMR 8243, CNRS & Université Paris Cité) and the LMF lab (UMR 9021, CNRS & Université Paris-Saclay).
...
Further information about CDuce is available on the [ℂDuce website](http://www.cduce.org).
